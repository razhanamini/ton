...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    forwardMessages(chat_id: number | string, from_chat_id: number | string, message_ids: number[], other?: Other<R, "forwardMessages", "chat_id" | "from_chat_id" | "message_ids">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").MessageId[]>;
    /**
     ...
     */
    copyMessages(chat_id: number | string, from_chat_id: number | string, message_ids: number[], other?: Other<R, "copyMessages", "chat_id" | "from_chat_id" | "message_ids">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").MessageId[]>;
    /**
    ...
    editMessageLiveLocation(chat_id: number | string, message_id: number, latitude: number, longitude: number, other?: Other<R, "editMessageLiveLocation", "chat_id" | "message_id" | "inline_message_id" | "latitude" | "longitude">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Location;
    })>;
    /**
     ...
     */
    stopMessageLiveLocation(chat_id: number | string, message_id: number, other?: Other<R, "stopMessageLiveLocation", "chat_id" | "message_id" | "inline_message_id">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Location;
    })>;
    /**
     * Use this method to stop updating a live location message before live_period expires. On success, if the message is not an inline message, the edited Message is returned, otherwise True is returned.
     ...
     * **Official reference:** https://core.telegram.org/bots/api#stopmessagelivelocation
     */
    stopMessageLiveLocationInline(inline_message_id: string, other?: Other<R, "stopMessageLiveLocation", "chat_id" | "message_id" | "inline_message_id">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        location: import("@grammyjs/types/message").Location;
    })>;
    /**
     ...
     */
    sendPaidMedia(chat_id: number | string, star_count: number, media: InputPaidMedia[], other?: Other<R, "sendPaidMedia", "chat_id" | "star_count" | "media">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.PaidMediaMessage>;
    /**
     ...
     */
    sendPoll(chat_id: number | string, question: string, options: (string | InputPollOption)[], other?: Other<R, "sendPoll", "chat_id" | "question" | "options">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.PollMessage>;
    /**
     ...
     */
    sendChecklist(business_connection_id: string, chat_id: number, checklist: InputChecklist, other?: Other<R, "sendChecklist", "business_connection_id" | "chat_id" | "checklist">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.ChecklistMessage>;
    /**
     ...
     */
    editMessageChecklist(business_connection_id: string, chat_id: number, message_id: number, checklist: InputChecklist, other?: Other<R, "editMessageChecklist", "business_connection_id" | "chat_id" | "messaage_id" | "checklist">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.ChecklistMessage>;
    /**
     ...
     */
    sendDice(chat_id: number | string, emoji: (string & Record<never, never>) | "🎲" | "🎯" | "🏀" | "⚽" | "🎳" | "🎰", other?: Other<R, "sendDice", "chat_id" | "emoji">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.DiceMessage>;
    /**
     ...
     */
    getUserProfileAudios(user_id: number, other?: Other<R, "getUserProfileAudios", "user_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").UserProfileAudios>;
    /**
     ...
     */
    getUserChatBoosts(chat_id: number | string, user_id: number, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").UserChatBoosts>;
    /**
     ...
     */
    getUserGifts(user_id: number, other?: Other<R, "getUserGifts", "user_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").OwnedGifts>;
    /**
     ...
     */
    getChatGifts(chat_id: number, other?: Other<R, "getChatGifts", "chat_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").OwnedGifts>;
    /**
     ...
     */
    getBusinessConnection(business_connection_id: string, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").BusinessConnection>;
    /**
     ...
     */
    getFile(file_id: string, signal?: AbortSignal): Promise<import("@grammyjs/types/message").File>;
     ...
     */
    createChatSubscriptionInviteLink(chat_id: number | string, subscription_period: number, subscription_price: number, other?: Other<R, "createChatSubscriptionInviteLink", "chat_id" | "subscription_period" | "subscription_price">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatInviteLink>;
    /**
     ...
     */
    editChatSubscriptionInviteLink(chat_id: number | string, invite_link: string, other?: Other<R, "editChatSubscriptionInviteLink", "chat_id" | "invite_link">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatInviteLink>;
    /**
     ...
     */
    getChat(chat_id: number | string, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatFullInfo>;
    /**
     ...
     */
    getChatAdministrators(chat_id: number | string, signal?: AbortSignal): Promise<(import("@grammyjs/types/manage").ChatMemberOwner | import("@grammyjs/types/manage").ChatMemberAdministrator)[]>;
     ...
     */
    getForumTopicIconStickers(signal?: AbortSignal): Promise<import("@grammyjs/types/message").Sticker[]>;
    /**
     ...
     */
    createForumTopic(chat_id: number | string, name: string, other?: Other<R, "createForumTopic", "chat_id" | "name">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ForumTopic>;
    /**
     ...
     */
    getMyName(other?: Other<R, "getMyName">, signal?: AbortSignal): Promise<import("@grammyjs/types/settings").BotName>;
    /**
     ...
     */
    getMyDescription(other?: Other<R, "getMyDescription">, signal?: AbortSignal): Promise<import("@grammyjs/types/settings").BotDescription>;
    /**
     ...
     */
    getMyShortDescription(other?: Other<R, "getMyShortDescription">, signal?: AbortSignal): Promise<import("@grammyjs/types/settings").BotShortDescription>;
    /**
     ...
     */
    getChatMenuButton(other?: Other<R, "getChatMenuButton">, signal?: AbortSignal): Promise<import("@grammyjs/types/settings").MenuButton>;
    /**
     ...
     */
    getMyDefaultAdministratorRights(other?: Other<R, "getMyDefaultAdministratorRights">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatAdministratorRights>;
    /**
     ...
     */
    getMyStarBalance(signal?: AbortSignal): Promise<import("@grammyjs/types/payment").StarAmount>;
    /**
     ...
     */
    editMessageText(chat_id: number | string, message_id: number, text: string, other?: Other<R, "editMessageText", "chat_id" | "message_id" | "inline_message_id" | "text">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        text: string;
    } & Partial<{
        entities: import("@grammyjs/types/message").MessageEntity[];
    }>)>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagetext
     */
    editMessageTextInline(inline_message_id: string, text: string, other?: Other<R, "editMessageText", "chat_id" | "message_id" | "inline_message_id" | "text">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        text: string;
    } & Partial<{
        entities: import("@grammyjs/types/message").MessageEntity[];
    }>)>;
     ...
     */
    editMessageMedia(chat_id: number | string, message_id: number, media: InputMedia, other?: Other<R, "editMessageMedia", "chat_id" | "message_id" | "inline_message_id" | "media">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message)>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagemedia
     */
    editMessageMediaInline(inline_message_id: string, media: InputMedia, other?: Other<R, "editMessageMedia", "chat_id" | "message_id" | "inline_message_id" | "media">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message)>;
    /**
     ...
     */
    getBusinessAccountStarBalance(business_connection_id: string, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").StarAmount>;
    /**
     ...
     */
    getBusinessAccountGifts(business_connection_id: string, other: Other<R, "getBusinessAccountGifts", "business_connection_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").OwnedGifts>;
    /**
     ...
     */
    postStory(business_connection_id: string, content: InputStoryContent, active_period: number, other: Other<R, "postStory", "business_connection_id" | "content" | "active_period">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Story>;
    /**
     ...
     */
    repostStory(business_connection_id: string, from_chat_id: number, from_story_id: number, active_period: number, other: Other<R, "repostStory", "business_connection_id" | "from_chat_id" | "from_story_id" | "active_period">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Story>;
    /**
     ...
     */
    editStory(business_connection_id: string, story_id: number, content: InputStoryContent, other: Other<R, "editStory", "business_connection_id" | "story_id" | "content">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Story>;
    /**
     ...
     */
    getCustomEmojiStickers(custom_emoji_ids: string[], signal?: AbortSignal): Promise<import("@grammyjs/types/message").Sticker[]>;
    /**
     ...
     */
    uploadStickerFile(user_id: number, sticker_format: "static" | "animated" | "video", sticker: InputFile, signal?: AbortSignal): Promise<import("@grammyjs/types/message").File>;
    /**
     ...
     */
    getAvailableGifts(signal?: AbortSignal): Promise<import("@grammyjs/types/payment").Gifts>;
    /**
     ...
     */
    savePreparedInlineMessage(user_id: number, result: InlineQueryResult, other?: Other<R, "savePreparedInlineMessage", "user_id" | "result">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").PreparedInlineMessage>;
    /**
     ...
     */
    savePreparedKeyboardButton(user_id: number, button: KeyboardButton.RequestUsersButton | KeyboardButton.RequestChatButton | KeyboardButton.RequestManagedBotButton, signal?: AbortSignal): Promise<import("@grammyjs/types/markup").PreparedKeyboardButton>;
    /**
     ...
     */
    sendInvoice(chat_id: number | string, title: string, description: string, payload: string, currency: string, prices: readonly LabeledPrice[], other?: Other<R, "sendInvoice", "chat_id" | "title" | "description" | "payload" | "currency" | "prices">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Message.InvoiceMessage>;
    /**
     ...
     */
    getStarTransactions(other?: Other<R, "getStarTransactions">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").StarTransactions>;
    /**
     ...
     */
    setGameScore(chat_id: number, message_id: number, user_id: number, score: number, other?: Other<R, "setGameScore", "chat_id" | "message_id" | "inline_message_id" | "user_id" | "score">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        game: import("@grammyjs/types/message").Game;
    })>;
    /**
     * Use this method to set the score of the specified user in a game message. On success, if the message is not an inline message, the Message is returned, otherwise True is returned. Returns an error, if the new score is not greater than the user's current score in the chat and force is False.
     *
     ...
     * **Official reference:** https://core.telegram.org/bots/api#setgamescore
     */
    setGameScoreInline(inline_message_id: string, user_id: number, score: number, other?: Other<R, "setGameScore", "chat_id" | "message_id" | "inline_message_id" | "user_id" | "score">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update").Update.Edited & import("@grammyjs/types/message").Message.CommonMessage & {
        game: import("@grammyjs/types/message").Game;
    })>;
    /**
