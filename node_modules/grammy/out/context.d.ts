import { type Api, type Other as OtherApi } from "grammy/out/core/api";
import { type Methods, type RawApi } from "grammy/out/core/client";
import { type Filter, type FilterCore, type FilterQuery } from "grammy/out/filter";
...
export declare class Context implements RenamedUpdate {
    ...
    get businessConnection(): import("@grammyjs/types/manage").BusinessConnection | undefined;
    ...
    get deletedBusinessMessages(): import("@grammyjs/types/manage").BusinessMessagesDeleted | undefined;
    /** Alias for `ctx.update.message_reaction` */
    get messageReaction(): import("@grammyjs/types/message").MessageReactionUpdated | undefined;
    /** Alias for `ctx.update.message_reaction_count` */
    get messageReactionCount(): import("@grammyjs/types/message").MessageReactionCountUpdated | undefined;
    ...
    get managedBot(): import("@grammyjs/types/manage").ManagedBotUpdated | undefined;
    ...
    get chatBoost(): import("@grammyjs/types/manage").ChatBoostUpdated | undefined;
    /** Alias for `ctx.update.removed_chat_boost` */
    get removedChatBoost(): import("@grammyjs/types/manage").ChatBoostRemoved | undefined;
    /** Alias for `ctx.update.purchased_paid_media` */
    get purchasedPaidMedia(): import("@grammyjs/types/payment").PaidMediaPurchased | undefined;
    /**
     ...
     */
    forwardMessages(chat_id: number | string, message_ids: number[], other?: Other<"forwardMessages", "chat_id" | "from_chat_id" | "message_ids">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").MessageId[]>;
    /**
     ...
     */
    copyMessages(chat_id: number | string, message_ids: number[], other?: Other<"copyMessages", "chat_id" | "from_chat_id" | "message_ids">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").MessageId[]>;
    /**
     ...
     */
    getUserProfileAudios(other?: Other<"getUserProfileAudios", "user_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").UserProfileAudios>;
    /**
     ...
     */
    getUserChatBoosts(chat_id?: number | string, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").UserChatBoosts>;
    /**
     ...
     */
    getUserGifts(other?: Other<"getUserGifts", "user_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").OwnedGifts>;
    /**
     ...
     */
    getChatGifts(other?: Other<"getChatGifts", "chat_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").OwnedGifts>;
    /**
     ...
     */
    getBusinessConnection(signal?: AbortSignal): Promise<import("@grammyjs/types/manage").BusinessConnection>;
    /**
     ...
     */
    getFile(signal?: AbortSignal): Promise<import("@grammyjs/types/message").File>;
     ...
     */
    createChatSubscriptionInviteLink(subscription_period: number, subscription_price: number, other?: Other<"createChatSubscriptionInviteLink", "chat_id" | "subscription_period" | "subscription_price">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatInviteLink>;
    /**
     ...
     */
    editChatSubscriptionInviteLink(invite_link: string, other?: Other<"editChatSubscriptionInviteLink", "chat_id" | "invite_link">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatInviteLink>;
    /**
     ...
     */
    getChat(signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ChatFullInfo>;
    /**
     ...
     */
    getChatAdministrators(signal?: AbortSignal): Promise<(import("@grammyjs/types/manage").ChatMemberOwner | import("@grammyjs/types/manage").ChatMemberAdministrator)[]>;
     ...
     */
    createForumTopic(name: string, other?: Other<"createForumTopic", "chat_id" | "name">, signal?: AbortSignal): Promise<import("@grammyjs/types/manage").ForumTopic>;
    /**
     ...
     */
    getChatMenuButton(other?: Other<"getChatMenuButton">, signal?: AbortSignal): Promise<import("@grammyjs/types/settings").MenuButton>;
    /**
     ...
     */
    getBusinessAccountStarBalance(signal?: AbortSignal): Promise<import("@grammyjs/types/payment").StarAmount>;
    /**
     ...
     */
    getBusinessAccountGifts(other: Other<"getBusinessAccountGifts", "business_connection_id">, signal?: AbortSignal): Promise<import("@grammyjs/types/payment").OwnedGifts>;
    /**
     ...
     */
    postStory(content: InputStoryContent, active_period: number, other: Other<"postStory", "business_connection_id" | "content" | "active_period">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Story>;
    /**
     ...
     */
    repostStory(active_period: number, other: Other<"repostStory", "business_connection_id" | "from_chat_id" | "from_story_id" | "active_period">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Story>;
    /**
     ...
     */
    editStory(story_id: number, content: InputStoryContent, other: Other<"editStory", "business_connection_id" | "story_id" | "content">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").Story>;
    /**
     ...
     */
    getCustomEmojiStickers(signal?: AbortSignal): Promise<import("@grammyjs/types/message").Sticker[]>;
    /**
     ...
     */
    savePreparedInlineMessage(result: InlineQueryResult, other?: Other<"savePreparedInlineMessage", "user_id" | "result">, signal?: AbortSignal): Promise<import("@grammyjs/types/message").PreparedInlineMessage>;
    /**
     ...
     */
    savePreparedKeyboardButton(button: KeyboardButton.RequestUsersButton | KeyboardButton.RequestChatButton | KeyboardButton.RequestManagedBotButton, signal?: AbortSignal): Promise<import("@grammyjs/types/markup").PreparedKeyboardButton>;
    /**
